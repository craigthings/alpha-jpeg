    ...
    1: [
      function(e, t, n) {
        ...
        function o(e, t) {
          ...
          return o.putImageData(s, 0, 0), o.putImageData(d, a, 0), i(n, t);
        }
          ...
          e.load = function(e, t, n) {
            ...
            "svg" == o &&
              (s.onload = function() {
                var n = s.width,
                  o = s.height;
                (d.style.width = n / 2 / r + "px"),
                (d.style.height = o / r + "px"),
              ...
              (s.onload = function() {
                ...
                (i.width = t),
                (i.height = n),
                (i.style.width = t / r + "px"),
                (i.style.height = n / r + "px"),
                (l.style.width = t / 2 / r + "px"),
                (l.style.height = n / r + "px"),
                (l.style.overflow = "hidden");
                var o = i.getContext("2d");
                o.drawImage(s, 0, 0);
                for (
                  var d = o.getImageData(0, 0, t / 2, n),
                    c = d.data,
                    p = o.getImageData(t / 2, 0, t / 2, n),
                    u = p.data,
                    g = 0,
                    m = c.length; g < m; g += 4
                ) {
